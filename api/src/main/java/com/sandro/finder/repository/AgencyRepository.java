...
public class AgencyRepository {
    ...
    public List<Agency> getAgencies(String latitude, String longitude){
        ...
        agencies.add(new Agency("(11) 2628-3135", "Av. Washington Luís, 1171 - Santo Amaro, São Paulo - SP, 04662-002", "10"));
        ...
        agencies.add(new Agency("(11) 2628-3135", "Av. de Pinedo, 294 - Santo Amaro, São Paulo - SP, 04764-000", "10"));
        agencies.add(new Agency("(11) 2628-3135", "Av. de Pinedo, 505 - Socorro, São Paulo - SP, 04764-001", "10"));
        return agencies;
    }
}
